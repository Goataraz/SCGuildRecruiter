...
local function CreateWhisperDefineFrame()
	...
	SGI_Whisper.title:SetText(SGI.L["SC Recruiter Custom Whisper"])
...
local function CreateOptions()
	...
	local WhisperMode = {
		SGI.L["Invite only (Do Not Use"],
		SGI.L["Invite, then whisper (Do Not Use"],
		SGI.L["Whisper only"],
	}
...
local function CreateMinimapButton()
	...
	f:SetNormalTexture("Interface\\AddOns\\SCGuildRecruiter\\media\\SGI_MiniMapButton")
	f:SetPushedTexture("Interface\\AddOns\\SCGuildRecruiter\\media\\SGI_MiniMapButtonPushed")
